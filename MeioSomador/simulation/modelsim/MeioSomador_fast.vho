...
-- b	=>  Location: PIN_A13,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default


ARCHITECTURE structure OF MeioSomador IS
...
-- Equation(s):
-- \Ts~0_combout\ = (\b~combout\ & \a~combout\)
